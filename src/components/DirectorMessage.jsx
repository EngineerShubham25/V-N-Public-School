          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="space-y-4 text-sm text-slate-700 pt-2">
                ...
                {/* Additional 5 Points shown when expanded */}
                {isExpanded && (
                  <>
                    {/* 3. Safety & Well-being */}
                    <div className="bg-white p-4 rounded-xl border border-slate-200 space-y-1">
              ...
              <div className="pt-2">
                {!isExpanded ? (
                  <button
                    ...
                    className="w-full sm:w-auto bg-blue-100 hover:bg-blue-200 text-blue-900 font-bold px-5 py-2.5 rounded-xl text-xs flex items-center justify-center gap-2 transition-all"
                  >
                    <span>View More Features & Vision</span>
                  ...
                  <button
                    onClick={() => {
                      setIsExpanded(false);
                      const elem = document.getElementById('director');
                      if (elem) elem.scrollIntoView({ behavior: 'smooth' });
                    }}
                    className="w-full sm:w-auto bg-slate-200 hover:bg-slate-300 text-slate-800 font-bold px-5 py-2.5 rounded-xl text-xs flex items-center justify-center gap-2 transition-all"
                  >
                    <span>View Less</span>
              ...
              {/* Permanent Closing Quote Box ("Our Mission") */}
